...
import { createDiscount, getDiscountById } from "../models/Discounts.server";
        ...
        discount = {
          ...
          customerGets: {
            ...
            value: {
              ...
              DiscountOnQuantity: {
                DiscountAmount: {
                  amount: manualBasicDiscoutData?.customerGets?.value?.effect?.amount?.amount || null,
                  currencyCode: manualBasicDiscoutData?.customerGets?.value?.effect?.amount?.currencyCode || null
                },
                DiscountPercentage: {
                  percentage: manualBasicDiscoutData?.customerGets?.value?.effect?.percentage || null
                },
                quantity: {
                  quantity: manualBasicDiscoutData?.customerGets?.value?.quantity?.quantity || null
                }
              },
        ...
        discount = {
          ...
          customerGets: {
            ...
            value: {
              ...
              DiscountOnQuantity: {
                DiscountAmount: {
                  amount: AutomaticBasicDiscountData?.customerGets?.value?.effect?.amount?.amount || null,
                  currencyCode: AutomaticBasicDiscountData?.customerGets?.value?.effect?.amount?.currencyCode || null
                },
                DiscountPercentage: {
                  percentage: AutomaticBasicDiscountData?.customerGets?.value?.effect?.DiscountPercentage?.percentage || null
                },
                quantity: {
                  quantity: AutomaticBasicDiscountData?.customerGets?.value?.quantity?.quantity || null
                }
              },
          ...
          discount = {
            ...
            customerGets: {
              ...
              value: {
                ...
                DiscountOnQuantity: {
                  DiscountAmount: {
                    amount: ManualBxGyDiscountData.customerGets?.value?.effect?.DiscountAmount?.appliesOnEachItem?.amount?.amount || null,
                    currencyCode: ManualBxGyDiscountData.customerGets?.value?.DiscountOnQuantity?.effect?.DiscountAmount?.appliesOnEachItem?.amount?.currencyCode || null
                  },
                  DiscountPercentage: {
                    percentage: ManualBxGyDiscountData.customerGets?.value?.effect?.DiscountPercentage?.percentage || null
                  },
                  quantity: {
                    quantity: ManualBxGyDiscountData.customerGets?.value?.DiscountOnQuantity?.quantity?.quantity || null
                  }
                },
          ...
          if(AutomaticBxGyDiscount.title) {
            ...
            discount = {
              ...
              customerBuys: {
                ...
                value: {
                  amount: AutomaticBxGyDiscount.customerBuys?.value?.amount || 0,
                  quantity: AutomaticBxGyDiscount.customerBuys?.value?.quantity || 1
                }
              },
              code: null,
              customerSelection:{
              ...
              customerGets: {
                ...
                value: {
                  ...
                  DiscountOnQuantity: {
                    ...
                    DiscountPercentage: {
                      percentage: AutomaticBxGyDiscount.customerGets?.value?.effect?.DiscountPercentage?.percentage || null
                    },
                    quantity: {
